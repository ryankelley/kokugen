...
namespace Kokugen.Core.Services
{
    ...
    public class ProjectService : IProjectService
    {
        ...
        public Project CreateProject(string projectName, string projectDescription, Company company)
        {
            ...
            project.AddBoardColumn(new CustomBoardColumn { ColumnOrder = 1, Name = "Working", Description = "Items in this column are being worked on"});
            project.AddBoardColumn(new CustomBoardColumn { ColumnOrder = 1, Name = "Done", Description = "Items in this column are Done"});
