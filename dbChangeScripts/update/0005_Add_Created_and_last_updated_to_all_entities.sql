...
Script created by SQL Compare version 8.0.0 from Red Gate Software Ltd at 4/15/2010 9:30:14 AM
...
BEGIN TRANSACTION
GO
PRINT N'Altering [dbo].[BoardColumns]'
GO
ALTER TABLE [dbo].[BoardColumns] ADD
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Altering [dbo].[Permissions]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Altering [dbo].[TaskCategories]'
GO
ALTER TABLE [dbo].[TaskCategories] ADD
[Created] [datetime] NULL,
[LastUpdated] [datetime] NULL
GO
IF @@ERROR<>0 AND @@TRANCOUNT>0 ROLLBACK TRANSACTION
