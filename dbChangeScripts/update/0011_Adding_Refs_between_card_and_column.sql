...
Script created by SQL Compare version 8.0.0 from Red Gate Software Ltd at 4/4/2010 10:49:51 PM
...
[BoardColumn_id] [uniqueidentifier] NULL
GO
...
CONSTRAINT [fk_column_to_card] FOREIGN KEY ([BoardColumn_id]) REFERENCES [dbo].[BoardColumns] ([Id])
GO
IF @@ERROR<>0 AND @@TRANCOUNT>0 ROLLBACK TRANSACTION
GO
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
